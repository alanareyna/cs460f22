...
int main ()
{
    ...
    cout << "Calling Default constructor rational(const int, const int) with values 1 and 2" << endl;
    rational fractionRational(1,2); // Method #1: Regular out of scope destructor testing
    cout << "Calling Default constructor rational(const double) with value 0.5" << endl;
    rational decimalRational(0.5); // Method #1: Regular out of scope destructor testing
    cout << "Calling Default constructor rational(const int, const int) with values 1 and 2" << endl;
    cout << "Calling copy constructor to assign default constructor to pointer rational variable" << endl;
    ...
    cout << "Calling output operators (<<):" << endl;
    cout << "Fraction Rational: " << fractionRational << endl;  // prints out '1/2'
    cout << "Decimal Rational: " << double(decimalRational) << endl; // prints out '0.5'
